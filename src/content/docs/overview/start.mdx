...
5. Register commands and deploy
   ...
   If you get an error with `npm run register`, try this [tsconfig.json](https://github.com/LuisFun/discord-hono-example/blob/main/tsconfig.json).
