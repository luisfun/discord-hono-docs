...
1. Create a new project
   ...
   - [.env.example](https://github.com/luisfun/discord-hono-examples/blob/main/workerd-hello-world/.env.example) Rename file to .env
   - package.json
   - [tsconfig.json](https://github.com/luisfun/discord-hono-examples/blob/main/workerd-hello-world/tsconfig.json) When using TypeScript
   - ...
   </FileTree>
